...
App({
    ...
    onLaunch: function () {
        ...
        this.globalData.login = function () {
            _this.globalData.loginReady = new Promise(function (resolve) { return wx.login({
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, (0, client_1.loginWithWeChat)(res.code)];
                            case 1:
                                session = _a.sent();
                            ...
                            case 2:
                                error_1 = _a.sent();
                                wx.showToast({ title: error_1 instanceof Error ? error_1.message : '微信登录失败', icon: 'none' });
                                return [3 /*break*/, 4];
                            case 3:
                                resolve();
                                return [7 /*endfinally*/];
