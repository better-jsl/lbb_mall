...
Page({
        ...
        return __awaiter(this, void 0, void 0, function () { var _a, _b, _c; return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _a = this.setData;
                    _b = [{}];
                    return [4 /*yield*/, (0, client_1.request)("/orders/".concat(id))];
                case 1:
                    _a.apply(this, [__assign.apply(void 0, [__assign.apply(void 0, _b.concat([_d.sent()])), { networkError: false }])]);
                    return [3 /*break*/, 3];
                case 2:
                    _c = _d.sent();
    ...
    retryNetwork: function () { if (this.data.orderID) {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                _c.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, (0, client_1.request)('/orders/verify', 'POST', { code: result, orderId: this.data.orderID })];
                            case 1:
                                _c.sent();
