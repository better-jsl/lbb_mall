...
const { prefix: prefix } = config_1.default, name = `${prefix}-chat-markdown-code`, markdownName = `${prefix}-chat-markdown`;
let ChatMarkdownCode = class extends index_1.SuperComponent {
...
ChatMarkdownCode = (0, tslib_1.__decorate)([(0, index_1.wxComponent)()], ChatMarkdownCode);
exports.default = ChatMarkdownCode;
